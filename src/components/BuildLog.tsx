...
const getBuildAccent = (idx: number) => {
  switch (idx) {
    case 0:
      return {
        category: 'text-[#0284C7] dark:text-[#58C7D9]',
        hoverBorder: 'hover:border-[#0284C7]/40 dark:hover:border-[#58C7D9]/40',
        arrow: 'text-[#0284C7] dark:text-[#58C7D9]',
      };
    case 1:
      return {
        category: 'text-[#0D9488] dark:text-[#4AAE9B]',
        hoverBorder: 'hover:border-[#0D9488]/40 dark:hover:border-[#4AAE9B]/40',
        arrow: 'text-[#0D9488] dark:text-[#4AAE9B]',
      };
    default:
      return {
        category: 'text-[#6D5DE7] dark:text-[#8B7CFF]',
        hoverBorder: 'hover:border-[#6D5DE7]/40 dark:hover:border-[#8B7CFF]/40',
        arrow: 'text-[#6D5DE7] dark:text-[#8B7CFF]',
      };
  }
};
