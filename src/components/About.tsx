...
export const About: React.FC = () => {
  return (
    <section id="about" className="w-full bg-[#F8FAFC] dark:bg-[#0C0C0D] py-20 md:py-28 px-6 md:px-10 lg:px-16 border-t border-slate-200/80 dark:border-[#1F1F1F]/80 transition-colors duration-200">
      <div className="max-w-[1200px] mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <motion.div
            ...
            className="lg:col-span-7 bg-white dark:bg-[#141414] border border-slate-200 dark:border-[#1F1F1F] hover:border-[#0284C7]/30 dark:hover:border-[#58C7D9]/30 rounded-3xl p-8 md:p-10 space-y-6 text-[#5F6670] dark:text-[#878787] text-base leading-relaxed transition-colors duration-200 shadow-sm"
          >
            ...
            <div className="pt-4 flex flex-wrap gap-4 text-xs font-mono text-[#111318] dark:text-[#F4F4F4]">
          ...
          <motion.div
            ...
            className="lg:col-span-5 bg-white dark:bg-[#141414] border border-slate-200 dark:border-[#1F1F1F] hover:border-[#B45309]/30 dark:hover:border-[#D6A85B]/30 rounded-3xl p-8 md:p-10 space-y-6 flex flex-col justify-between transition-colors duration-200 shadow-sm"
          >
            <div className="space-y-4">
              <span className="text-[11px] font-mono uppercase tracking-[0.25em] text-[#B45309] dark:text-[#D6A85B]">
                PHILOSOPHY
              </span>
              ...
              <p className="text-xs text-[#5F6670] dark:text-[#878787] font-normal leading-relaxed">
