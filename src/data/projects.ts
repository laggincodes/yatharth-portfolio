...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'A voice-first healthcare AI assistant built around real-time conversational interaction using Agora.',
    technologies: ['Agora', 'Gemini', 'Voice AI', 'React', 'TypeScript', 'Next.js'],
    role: 'Creator & Developer',
